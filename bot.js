...
'numbergame' : (msg) => {
  ...
  let win = false,
  amount = 0;
  let maxt = (extremeflag) ? 12 : 8;
  console.log(hardtwist);
	if (hardtwist === true) maxt = maxt - 3;
	msg.channel.send("You have " + maxt + " chances! Guess the number correctly and you win!");
